...
namespace TheMetroTheme.Filters
{
    public class AlternateCssFilter : FilterProvider, IResultFilter 
    {
        ...
        public void OnResultExecuting(ResultExecutingContext filterContext) 
        {
            ...
            //Charles Gauvin
            //There is a minor bug with the following if statement that is preventing the theme
            //to load in preview from the dashboard. I commented out the if statement on 14/02/2015
